...
/**
 /**
 * 文件描述:// ICoastline 无网络弹框
 * 作者：M、
 * 创建时间：2018/8/13
 * 更改时间：2018/8/13
 */

public class NetWoekLayer {

    private static final String TAG = "NetWoekLayer";
    ...
    public NetWoekLayer(Context context) {
    ...
    private void initView() {
        ...
        mPopView = layoutInflater.inflate(R.layout.layout_network, null);
    }
    ...
    private void initLayoutParams() {
        ...
        mLayoutParams.x = 0;
        mLayoutParams.y = AppScrenUtils.getStatusBarHeight(mContext)+55;
    }
...
//                        if (deltaX > 10 | deltaY > 10) isMove = true;
    ...
    public NetWoekLayer setListener(FloatingLayerListener listener) {
